...
Minimal Docker Compose deployment for [Felix Agent](https://github.com/frdteknikelektro/felix-agent).

The Felix image already contains the application, setup wizard, bundled skills,
and runtime tools. This repository only provides the Compose file and the two
...
# Wait for Felix's health check before probing it.
...
The console is bound to loopback by default. Exposing it beyond the local host
