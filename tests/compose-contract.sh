...
if set(default_images.values()) != {"frdinawan/felix-agent:0.3.1"}:
...
if rg -n '0\.2\.3' README.md; then
  echo "compose contract failed: README contains stale 0.2.3 references" >&2
  exit 1
fi
